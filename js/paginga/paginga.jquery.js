    ...
    "use strict";
        ...
        $.extend(paginga.prototype,
        {
            ...
            bindEvents: function()
            {
                ...
                $( "#update-pagination-items" ).click(function() {
					plugin.updateItems.call(plugin);
					plugin.showPage.call(plugin);
					plugin.showFirstPage.call(plugin);
				});
            },
            ...
            showPage: function()
            {
                ...
                if(pageNumbers)
                {
					...
					// Only create pager controls if more than one page
					if (lastPage > 1) {
	                    ...
	                    // Show pager controls
	                    element.find('.pager').css("display", "block");
					} else {
						// Hide pager controls if only one page
						element.find('.pager').css("display", "none");
					}	                   
                }
            },
